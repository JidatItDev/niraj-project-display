      ...
      <div className="w-full flex flex-col bg-[#FAFAFA] justify-center items-center">
        ...
        <div className="w-full p-5 mt-[30px] shadow-lg rounded-lg bg-white mb-[30px] flex flex-col justify-center items-center gap-5">
          <h1 className="font-bold text-2xl text-center">
            Fill out Form for Referring a Friend
          </h1>
          <div className="w-full flex flex-col gap-3 justify-center items-center mt-[30px]">
            ...
            <TextField
              ...
              type="email"
              className="w-full md:w-[60%]"
              placeholder="Email of Person Being Referred"
            />
            <TextField
              onChange={handleChange}
              id="phoneNumber"
              name="phoneNumber"
              className="w-full md:w-[60%]"
              placeholder="Phone Number of Person Being Referred"
            />
            <TextField
              onChange={handleChange}
              id="dob"
              name="dob"
              className="w-full md:w-[60%]"
              placeholder="DOB of Person Being Referred"
            />
            <TextField
              onChange={handleChange}
              id="mailingAddress"
