                    ...
                    <>
                        ...
                        {index > 0 && (
							...
							<div className="w-full grid grid-cols-1 mt-[20px] mb-[20px] lg:grid-cols-2 gap-5 justify-center items-center">
								<div className="flex w-full flex-col justify-center items-start gap-2">
									<InputLabel htmlFor="mailingAddress">
										Mailing Address
									</InputLabel>
									<TextField
							...
							>
								...
								<DialogContent>
									<DialogContentText id="alert-dialog-description">
										Are you sure you want to submit the quote without
										inspections?
									</DialogContentText>
									<DialogContentText
										sx={{
									...
									>
										Note: The request will be submitted but your quote will not
										begin until the inspections are uploaded.
									</DialogContentText>
								</DialogContent>
								<DialogActions>
									<button
